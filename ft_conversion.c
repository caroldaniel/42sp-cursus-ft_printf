...
/*   Updated: 2021/08/04 22:58:02 by cado-car         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	// 	ft_convert_uxX(fmt, h, HEXAGONAL_L_BASE);
	// else if (h->conversion == 'X')
	// 	ft_convert_uxX(fmt, h, HEXAGONAL_U_BASE);
	// else if (h->conversion == '%')
	// 	ft_convert_pct(fmt, h);
	h->argument = "Hi!";
	h->len = 3;
}
